...
const Header = () => {
  ...
  const handleLogout = async () => {
    try {
      ...
      showToast.custom("Logout failed. Try again");
    }
  };
    ...
    <header className="olx-header">
      ...
      <div className="header-right">
        <div className="header-item wishlist-wrapper">
          <Link to="/wishlist" className="header-btn vertical-btn">
            <svg
            ...
            <div className="profile-container">
              ...
              {dropdownOpen && (
                <div className="profile-dropdown">
                  <p className="profile-email">{user.displayName || user.email}</p>
                  <Link to="/myads" className="dropdown-link">
                    My Ads
                  </Link>
